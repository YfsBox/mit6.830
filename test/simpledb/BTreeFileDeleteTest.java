...
public class BTreeFileDeleteTest extends SimpleDbTestBase {
	...
	public void testStealFromLeftLeafPage() throws Exception {
		...
		//System.out.printf("pageTuple is %d,slibingTuple is %d,tutal tuple/2 is %d\n",page.getNumTuples(),sibling.getNumTuples(),totalTuples/2);
	...
	public void testStealFromLeftInternalPage() throws Exception {
		...
		//System.out.printf("pageTuple is %d,slibingTuple is %d,tutal tuple/2 is %d\n",page.getNumEntries(),sibling.getNumEntries(),totalEntries);
